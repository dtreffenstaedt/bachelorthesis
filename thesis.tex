...
\begin{figure}[ht!]
	...
	\begin{tikzpicture}[->]
		...
		\draw (1,-3.5) -- ++(0,2) node[left] {excitation} -- ++(0,2);
		
		\draw (1.5,0.5) -- ++(2,0) node [above] {transport} -- ++(2,0);
