...
\begin{figure}[ht!]
	...
	\begin{tikzpicture}[->]
		...
		\node (terminal2) [below=of decide2, draw, terminal] {END};
		...
		\path (decide2l) ++(-1,0) coordinate (decide2ll);
		...
		\draw (process2) -- (terminal2);
		\draw (process2) -| (decide2ll) |- (decide1);
