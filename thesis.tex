...
\begin{figure}[H]
	...
	\begin{tikzpicture}[>=latex, ->]
		...
		\node (shower) [above left=of scintillator] {Shower};
		
		\draw (shower) -- (scintillator) node [midway, above] {$\mu$};
...
\caption{Coincidence time histogram for large distance detector pair\cite{muonpi}}
