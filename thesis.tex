...
A method using the electromagnetic component of a cosmic air shower exploits the fact that the frequencies lie in the radio range and can be detected through normal radio Antennae\cite{SCHRODER20171}.
